...
const PARKET_PAGES = [
  ...
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Naturalle', url: 'carvalhos/', tags: 'carvalho europeu naturalle' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Mont Blanc', url: 'carvalhos/', tags: 'carvalho europeu mont blanc' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Smoke', url: 'carvalhos/', tags: 'carvalho europeu smoke' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Armani', url: 'carvalhos/', tags: 'carvalho europeu armani' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Wild Grey', url: 'carvalhos/', tags: 'carvalho europeu wild grey' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Nevado', url: 'carvalhos/', tags: 'carvalho europeu nevado' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Batman', url: 'carvalhos/', tags: 'carvalho europeu batman' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Cappuccino', url: 'carvalhos/', tags: 'carvalho europeu cappuccino capuccino' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Light Brown', url: 'carvalhos/', tags: 'carvalho europeu light brown' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Marrone', url: 'carvalhos/', tags: 'carvalho europeu marrone' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Milano', url: 'carvalhos/', tags: 'carvalho europeu milano' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu All Black', url: 'carvalhos/', tags: 'carvalho europeu all black' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Grigio Negro', url: 'carvalhos/', tags: 'carvalho europeu grigio negro' },
  { cat: 'Pisos › Carvalhos', name: 'Carvalho Europeu Giz', url: 'carvalhos/', tags: 'carvalho europeu giz' },
  { cat: 'Pisos › Grandiosos', name: 'Carvalho Europeu', url: 'grandiosos/', tags: 'carvalho europeu grandioso' },
  { cat: 'Pisos › Wood + Mármore', name: 'Carvalho Europeu + Mármore', url: 'listone-giordano/', tags: 'carvalho europeu travertino navona carrara nero marquina quartizitos' },
  { cat: 'Pisos › Clássicos', name: 'Chevron em Carvalho Europeu', url: 'classicos/', tags: 'carvalho europeu chevron mont blanc batman naturalle' },
  { cat: 'Pisos › Clássicos', name: 'Espinha de Peixe em Carvalho Europeu', url: 'classicos/', tags: 'carvalho europeu espinha de peixe baby brey' },
  { cat: 'Pisos › Clássicos', name: 'Versalles em Carvalho Europeu', url: 'classicos/', tags: 'carvalho europeu versalles versailles' },
  ...
  // ─── Pisos › Pinho de Riga ───
  { cat: 'Pisos › Pinho de Riga', name: 'Pinho de Riga', url: 'pinho-de-riga/', tags: 'piso pinho de riga' },
  ...
  { cat: 'Pisos', name: 'Brazil', url: 'index.html' },
  { cat: 'Pisos', name: 'Carvalhos', url: 'carvalhos/' },
  { cat: 'Pisos', name: 'Clássicos', url: 'classicos/' },
  { cat: 'Pisos', name: 'Eternos', url: 'eternos/' },
  { cat: 'Pisos', name: 'Grandiosos', url: 'grandiosos/' },
  { cat: 'Pisos', name: 'Listone Giordano', url: 'listone-giordano/' },
  { cat: 'Pisos', name: 'Pinho de Riga', url: 'pinho-de-riga/' },
  { cat: 'Pisos', name: 'Únicos', url: 'unicos/' },
...
const PARKET_PHOTOS = (() => {
  ...
  maUrls.forEach((src, idx) => {
    photos.push({ cat: 'Pisos › Wood + Mármore', name: maNames[idx+1], page: 'listone-giordano/', src });
  });
...
class ParketNav extends HTMLElement {
  ...
  _renderResults(query) {
    ...
    // Prefix relative URLs with the page's base ('../' on subfolder collection
    // pages, '' on root pages) so search links resolve from any page depth.
    const base = (typeof window !== 'undefined' && window.PARKET_BASE) ? String(window.PARKET_BASE) : '';
    const resolve = (u) => (/^(https?:)?\/\//.test(u) || u.startsWith('/')) ? u : base + u;
    this._results.innerHTML = list.map(p => `
      <a class="parket-search-result" href="${resolve(p.url)}">
